    ...
    return Table(
        data=[
            ...
            },
            {
                ...
                "uploader": "carol@startup.io",
                "size": "84.2 MB",
                "type": "video/mp4",
                "date": "2026-05-30",
            },
            {
                "filename": "avatar-update.jpg",
                "uploader": "dan@example.net",
                "size": "0.3 MB",
                "type": "image/jpeg",
                "date": "2026-05-30",
            },
...
async def flagged_files_list() -> Table:
    ...
    return Table(
        data=[
            {
                "filename": "bad-content.mp4",
                "uploader": "troll@example.com",
                "flag": "policy-violation",
                "reported_by": "user#8820",
                "date": "2026-05-30",
            },
            {
                "filename": "spam-banner.jpg",
                "uploader": "spam@bot.io",
                "flag": "spam",
                "reported_by": "auto-scan",
                "date": "2026-05-29",
            },
            {
                "filename": "pirated-movie.mp4",
                "uploader": "pirate@ship.net",
                "flag": "copyright",
                "reported_by": "user#4410",
                "date": "2026-05-29",
            },
        ]
    )
...
async def top_uploaders() -> Table:
    ...
    return Table(
        data=[
            {
                "user": "videocreator@studio.com",
                "files": 4_210,
                "storage": "210 GB",
                "last_upload": "2026-05-30",
            },
            {
                "user": "media@agency.io",
                "files": 2_840,
                "storage": "148 GB",
                "last_upload": "2026-05-29",
            },
            {
            ...
            {
                "user": "content@corp.com",
                "files": 940,
                "storage": "38 GB",
                "last_upload": "2026-05-28",
            },
        ]
    )
