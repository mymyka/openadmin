from openadmin import AdminPage, AreaChart, BarChart, LineChart, PieChart
...
@page.bar_chart("Signups by Platform", description="Monthly signups split by desktop and mobile")
...
@page.bar_chart("Error Rate by Service", description="Average errors per day across backend services")
...
@page.line_chart("Response Time", description="Average API response time vs p99 over 6 months")
...
@page.pie_chart("Users by Plan", description="Distribution of users across subscription plans")
...
@page.pie_chart("Traffic Sources", description="Where visitors are coming from this month")
