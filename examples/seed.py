...
FIRST_NAMES = [
    ...
    "Ivy", "Jake", "Karen", "Leo", "Mia", "Noah", "Olivia", "Paul",
    "Quinn", "Rachel", "Sam", "Tina", "Uma", "Victor", "Wendy", "Xander",
    "Yara", "Zoe", "Aaron", "Beth", "Carlos", "Diana", "Eric", "Fiona",
    "George", "Hannah", "Ian", "Julia", "Kevin", "Laura", "Mike", "Nina",
    "Oscar", "Priya", "Raj", "Sara", "Tom", "Ursula", "Vince", "Willa",
    "Xena", "Yusuf", "Zara", "Adam", "Bella", "Chris", "Dana", "Eli",
    "Faith", "Gary", "Holly", "Igor", "Jane", "Kyle", "Lisa", "Mark",
    "Nancy", "Owen", "Penny", "Quincy", "Rita", "Steve", "Tracy",
]

LAST_NAMES = [
    "Johnson", "Smith", "White", "Brown", "Martinez", "Lee", "Kim",
    "Davis", "Wilson", "Anderson", "Taylor", "Thomas", "Jackson",
    "Harris", "Martin", "Thompson", "Garcia", "Clark", "Lewis", "Young",
    "Walker", "Hall", "Allen", "Scott", "Green", "Adams", "Baker",
    "Carter", "Mitchell", "Nelson", "Perez", "Roberts", "Turner",
    "Phillips", "Campbell", "Parker", "Evans", "Edwards", "Collins",
    "Stewart", "Morris", "Rogers", "Reed", "Cook", "Morgan", "Bell",
    "Murphy", "Bailey", "Rivera", "Cooper", "Richardson", "Cox", "Ward",
]

EMAIL_DOMAINS = [
    "example.com", "corp.com", "startup.io", "company.net", "dev.org",
    "mail.co", "inbox.dev", "webmail.net", "fastmail.io", "proton.me",
]

BAN_REASONS = ["spam", "harassment", "abuse", "impersonation", "scraping", "policy-violation"]
...
def seed(conn: sqlite3.Connection) -> None:
    ...
    for i in range(1, 401):
        ...
        role = "premium" if plan == "premium" else (
            "moderator" if random.random() < 0.02 else (
                "admin" if random.random() < 0.005 else "free"
            )
        )
