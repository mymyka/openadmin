...
def user_list() -> Table:
    return Table(
        data=[
            {"id": 1, "name": "Alice Johnson", "email": "alice@example.com", "plan": "premium", "active": True},
            {"id": 2, "name": "Bob Smith", "email": "bob@example.com", "plan": "free", "active": True},
            {"id": 3, "name": "Carol White", "email": "carol@example.com", "plan": "premium", "active": False},
            {"id": 4, "name": "David Brown", "email": "david@example.com", "plan": "free", "active": True},
            {"id": 5, "name": "Eva Martinez", "email": "eva@example.com", "plan": "premium", "active": True},
        ]
    )
...
def recent_signups() -> Table:
    return Table(
        data=[
            {"id": 14382, "name": "Frank Lee", "email": "frank@example.com", "registered": "2026-05-30"},
            {"id": 14381, "name": "Grace Kim", "email": "grace@example.com", "registered": "2026-05-29"},
            {"id": 14380, "name": "Hank Davis", "email": "hank@example.com", "registered": "2026-05-29"},
            {"id": 14379, "name": "Ivy Chen", "email": "ivy@example.com", "registered": "2026-05-28"},
            {"id": 14378, "name": "Jake Wilson", "email": "jake@example.com", "registered": "2026-05-27"},
        ]
    )
...
def banned_user_list() -> Table:
    return Table(
        data=[
            {"id": 101, "name": "Spam Bot 1", "email": "spam1@evil.com", "reason": "spam", "banned_on": "2026-05-10"},
            {"id": 245, "name": "Troll Account", "email": "troll@bad.com", "reason": "harassment", "banned_on": "2026-05-15"},
            {"id": 389, "name": "Fake User", "email": "fake@nowhere.com", "reason": "impersonation", "banned_on": "2026-05-20"},
            {"id": 412, "name": "Abuser X", "email": "abuse@dark.com", "reason": "abuse", "banned_on": "2026-05-22"},
            {"id": 500, "name": "Bot Account", "email": "bot@scraper.io", "reason": "scraping", "banned_on": "2026-05-28"},
        ]
    )
